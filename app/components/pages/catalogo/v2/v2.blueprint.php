...
/*
 * Catalogo v2 page blueprint.
 *
 * Intencao: reaproveitar o mesmo conteudo do catalogo original com nova direcao visual.
 */
...
$catalogoItems = [
  CP::Template(
    componentName: '/pages/catalogo/v2/produto-secao',
    inserts: [
      'layout-class' => 'catalogo-v2-secao--right',
  ...
  CP::Template(
    componentName: '/pages/catalogo/v2/produto-secao',
    inserts: [
      'layout-class' => 'catalogo-v2-secao--left',
...
return [
  ...
  'inserts' => [
    'page-title' => 'Catalogo v2',
    'body-class' => 'h-dvh flex flex-col overflow-hidden bg-base-100',
    'body' => [
      CP::Plugin(componentName: '/plugins/navbar/navbar'),
      CP::Template(componentName: '/pages/catalogo/v2/'),
    ],
    'catalogo-v2-items' => $catalogoItems,
    'navbar-container-class' => ' catalogo-v2-navbar-container',
    'navbar-class' => ' catalogo-v2-navbar',
  ],
];
